...
function open_layout_mhub() {
  screen -S mhub -X split
  sleep 0.2
  screen -S mhub -X resize 85%

  screen -S mhub -X split -v
  sleep 0.2
  screen -S mhub -X select "MHUB-NODE"
  sleep 0.2

  screen -S mhub -X split
  screen -S mhub -X focus
  sleep 0.2
  screen -S mhub -X select "MINTER-NODE"
  sleep 0.2

  screen -S mhub -X split
  screen -S mhub -X focus
  sleep 0.2
  screen -S mhub -X select "ETH-NODE"
  sleep 0.2

  screen -S mhub -X focus
  sleep 0.2
  screen -S mhub -X select "MINTER-CONNECTOR"
  sleep 0.2

  screen -S mhub -X split
  screen -S mhub -X focus
  sleep 0.2
  screen -S mhub -X select "ETH-CONNECTOR"
  sleep 0.2

  screen -S mhub -X split
  screen -S mhub -X focus
  sleep 0.2
  screen -S mhub -X select "ORACLE"
  sleep 0.2

  screen -S mhub -X resize -h 50%
  sleep 0.2

  screen -S mhub -X focus
  sleep 0.2
  screen -S mhub -X select "BASH"
 }
